...
export default class girlnpc extends Phaser.Physics.Arcade.Sprite
{
  ...
  preUpdate(t = number, dt = number)
  {
    ...
    switch (this.private_direction) {
      case UP:
        this.setVelocity(0, -speed) && this.anims.play("back2", this) 
        break

      case DOWN:
        this.setVelocity(0, speed) && this.anims.play("walk2", this)
        break

      case LEFT:
        this.setVelocity(-speed, 0) && this.anims.play("left2", this)
        break

      case RIGHT:
        this.setVelocity(speed, 0) && this.anims.play("right2", this)
        break
    }
  }
